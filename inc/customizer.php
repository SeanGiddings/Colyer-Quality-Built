 ...
 */
function colyer_wp_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'colyer-wp' ),
				'description' => __( 'Height: &gt;80px', 'colyer-wp' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'colyer-wp' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'static'       => __( 'Static', 'colyer-wp' ),
				'fixed_top'    => __( 'Fixed to top', 'colyer-wp' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'colyer-wp' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'colyer-wp' ),
			'section'  => 'theme_header_section',
...
add_action( 'customize_register', 'colyer_wp_customize' );


/**
 * Bind JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function colyer_wp_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'colyer_wp_customize_preview_js' );
